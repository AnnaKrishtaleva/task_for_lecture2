...
/// функция ReducerMinTest() определяет мминимальный элемент массива,
/// переданного ей в качестве аргумента, и его позицию
/// mass_pointer - указатель исходный массив целых чисел
/// size - количество элементов в массиве
...
/// функция CompareForAndCilk_For() выводить на консоль время работы стандартного цикла for и параллельного цикла cilk_for от Intel Cilk Plus
/// sz - размер массива
void CompareForAndCilk_For(size_t sz) 
{
	...
	printf("Standard duration = %f ticks\n\n", duration.count());
